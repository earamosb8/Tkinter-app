...
datoAnchoBanda = tk.Label(myframe, text="xxxxxx", font="Calibri 12", background="white")
...
datoFrecuenciaInicial = tk.Label(myframe, text="xxxxxx", font="Calibri 12", background="white")
...
datoFrecuenciaFinal = tk.Label(myframe, text="xxxxxx", font="Calibri 12", background="white")
...
datoNumeroParticiones = tk.Label(myframe, text="xxxxxx", font="Calibri 12", background="white")
...
datoNumeroTotalPeriodos = tk.Label(myframe, text="xxxxxx", font="Calibri 12", background="white")
...
datoNumeroCapas = tk.Label(myframe, text="xxxxxx", font="Calibri 12", background="white")
datoNumeroCapas.place(x=350, y=310)

capa = tk.Label(myframe, text="Capa n", font="Calibri 12 bold", foreground="#08469B", background="white")
...
anchocapa = tk.Label(myframe, text="Ancho de la capa n:", font="Calibri 12", foreground="#08469B", background="white")
anchocapa.place(x=70, y=390)
datoanchocapa = tk.Label(myframe, text="xxxxxx", font="Calibri 12", background="white")
datoanchocapa.place(x=350, y=390)

tipoPerfil = tk.Label(myframe, text="Tipo de perfil para la capa n:", font="Calibri 12", foreground="#08469B",background="white")
tipoPerfil.place(x=70, y=430)
datoTipoPerfil = tk.Label(myframe, text="xxxxxx", font="Calibri 12", background="white")
datoTipoPerfil.place(x=350, y=430)

parametrosTipoPerfil = tk.Label(myframe, text="Parámetros del tipo de perfil:", font="Calibri 12", foreground="#08469B", background="white")
parametrosTipoPerfil.place(x=70, y=470)

parametroA = tk.Label(myframe, text="A", font="Calibri 12", foreground="#08469B", background="white")
parametroA.place(x=130, y=510)
datoParametroA = tk.Label(myframe, text="xxxxxx", font="Calibri 12", background="white")
datoParametroA.place(x=110, y=550)

parametroB = tk.Label(myframe, text="B", font="Calibri 12", foreground="#08469B", background="white")
parametroB.place(x=240, y=510)
datoParametroB = tk.Label(myframe, text="xxxxxx", font="Calibri 12", background="white")
datoParametroB.place(x=220, y=550)

parametroC = tk.Label(myframe, text="C", font="Calibri 12", foreground="#08469B", background="white")
parametroC.place(x=340, y=510)
datoParametroC = tk.Label(myframe, text="xxxxxx", font="Calibri 12", background="white")
datoParametroC.place(x=320, y=550)

numeroParticiones = tk.Label(myframe, text="Número de particiones:", font="Calibri 12", foreground="#08469B", background="white")
...
buttonSi = tk.Button(myframe, text = "Si", font="Calibri 12 bold", background="#B7C800", cursor="hand2")
buttonSi.place(x=180, y = 700, width=50, height=30)

buttonNo = tk.Button(myframe, text = "No", font="Calibri 12 bold", background="#B7C800", cursor="hand2")
