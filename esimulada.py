...
#Creación del Canvas
mycanvas = Canvas(framePadre, height=500, width=400)
...
myframe = Frame(mycanvas, height=700, width=500)
mycanvas.create_window((0,0), window=myframe, anchor="nw")

#Posicionamiento en pantalla del LabelFrame
framePadre.pack(fill="both", expand="yes", padx=2, pady=2)

tituloVentanaSimulada = tk.Label(myframe, text="Estructura simulada", font="Roboto 18 bold",background="white")
tituloVentanaSimulada.place(x=130, y=0)

nombreArchivo = tk.Label(myframe, text="Nombre del archivo:", font="Roboto 12", background="white")
...
anchoBanda = tk.Label(myframe, text="Ancho de banda para la frecuencia:", font="Roboto 12", background="white")
...
frecuenciaInicial = tk.Label(myframe, text="Frecuencia inicial:", font="Roboto 12", background="white")
...
frecuenciaFinal = tk.Label(myframe, text="Frecuencia final:", font="Roboto 12", background="white")
...
NumeroParticiones = tk.Label(myframe, text="Número de particiones de frecuencia:", font="Roboto 12", background="white")
...
NumeroTotalPeriodos = tk.Label(myframe, text="Número total de períodos:", font="Roboto 12", background="white")
...
NumeroCapas = tk.Label(myframe, text="Número de capas de la estructura:", font="Roboto 12", background="white")
...
capa = tk.Label(myframe, text="Capa n", font="Roboto 12 bold", background="white")
capa.place(x=70, y=350)

tipoPerfil = tk.Label(myframe, text="Tipo de perfil para la capa n:", font="Roboto 12", background="white")
...
buttonSi = tk.Button(myframe, text = "Si", font="Roboto 14 bold", cursor="hand2")
buttonSi.place(x=200, y = 650)

buttonNo = tk.Button(myframe, text = "No", font="Roboto 14 bold", cursor="hand2")
