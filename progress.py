...
def ventanaEdicionGrafica(ventanaproceso,nombre):
    ...
    def validar(event):
        print("Validando fuente..." + clicked[0].get())
    ...
    def validartamano(event,seccion):
        if seccion == "titulos":
            ...
            print("Validando tamaño titulos ..." + clicked[0].get()+" ,"+clicked[1].get())
        ...
        if seccion == "subtitulos":
            ...
            print("Validando tamaño subtitulos ..." + clicked[0].get()+" ,"+clicked[2].get())
        ...
        if seccion == "numeros":
            ...
            print("Validando tamaño subtitulos numeros ..." + clicked[0].get()+" ,"+clicked[3].get())
        ...
        if seccion == "colores":
            ...
            print("Validando color inicial ..." + clicked[5].get())
        ...
        if seccion == "colores2":
            ...
            print("Validando color final ..." + clicked[6].get())
